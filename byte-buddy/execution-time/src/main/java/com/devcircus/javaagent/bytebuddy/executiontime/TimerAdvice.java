...
public class TimerAdvice {
    ...
    /**
     * From this enter method we start the timer and pass that value to exit
     * method and the we getting the time speed for each method
     */
    ...
    static void exit(@Advice.Origin String method, @Advice.Enter long start) throws Exception {
        ...
        System.out.println("[AGENT] " + method + " took " + (end - start) + " milliseconds ");
    }
