...
/**
 * <p>
 * This benchmark measures the invocation speed of stub method invocations. All
 * classes implement {@link net.bytebuddy.benchmark.specimen.ExampleClass} and
 * call this class's super method invocation. Since it is not possible to create
 * a subclass with the JDK proxy utilities, the latter is omitted from the
 * benchmark.
 * </p>
 * <p>
...
public class SuperClassInvocationBenchmark {
    ...
    /**
     * An instance created by Byte Buddy for performing benchmarks on. This
     * instance is created by adding auxiliary classes that allow for an
     * invocation of a method from a delegation target.
     */
    private ExampleClass byteBuddyWithProxyInstance;

    /**
     * An instance created by Byte Buddy for performing benchmarks on. This
     * instance is created by adding super invocation methods which are exposed
    ...
    /**
     * An instance created by Byte Buddy for performing benchmarks on. This
     * instance is created by a delegation followed by a hard-coded super method
     * call.
     */
    ...
    /**
     * An instance created by Byte Buddy for performing benchmarks on. This
     * instance is created by hard-coding a super method invocation into the
     * intercepted method.
     */
    ...
    /**
     * Creates an instance for each code generation library. The classes are
     * extracted from the
    ...
    /**
     * Performs a benchmark of a super method invocation using Byte Buddy. This
     * benchmark uses an annotation-based approach which is more difficult to
     * optimize by the JIT compiler.
     *
     * @param blackHole A black hole for avoiding JIT erasure.
     */
    @Benchmark
    ...
    /**
     * Performs a benchmark of a super method invocation using Byte Buddy. This
     * benchmark also uses the annotation-based approach but hard-codes the
     * super method call subsequently to the method.
     *
     * @param blackHole A black hole for avoiding JIT erasure.
     */
    @Benchmark
