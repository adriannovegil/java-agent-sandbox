...
import com.devcircus.javaagent.benchmark.basic.specimen.ExampleInterface;
 ...
 * {@link net.bytebuddy.benchmark.specimen.ExampleInterface} which overrides all
 * methods to invoke the direct super class's implementation. The benchmark
 * furthermore creates an instance of this class since some code generation
 * frameworks rely on this property.
 * </p>
 * <p>
...
public class ClassByImplementationBenchmark {
    ...
    /**
     * The default reference value. By defining the default reference value as a
     * string type instead of as an object type, the field is inlined by the
     * compiler, similar to the primitive values.
     */
     ...
     * @throws java.lang.Exception If the reflective invocation causes an
     * exception.
     */
    @Benchmark
    ...
    /**
     * Performs a benchmark of an interface implementation using Byte Buddy.
     * This benchmark uses a type pool to compare against usage of the
     * reflection API.
     *
     * @return The created instance, in order to avoid JIT removal.
     * @throws java.lang.Exception If the reflective invocation causes an
    ...
    /**
     * Performs a benchmark of an interface implementation using javassist
     * proxies.
     *
     * @return The created instance, in order to avoid JIT removal.
     * @throws java.lang.Exception If the reflective invocation causes an
    ...
    /**
     * Performs a benchmark of an interface implementation using the Java Class
     * Library's utilities.
     *
     * @return The created instance, in order to avoid JIT removal.
     * @throws java.lang.Exception If the reflective invocation causes an
