 ...
 * classes implement {@link net.bytebuddy.benchmark.specimen.ExampleInterface}
 * and implement all methods to return the return type's default value,
...
public class StubInvocationBenchmark {
    ...
    /**
     * Performs a benchmark for a trivial class creation using the Java Class
     * Library's utilities.
     *
     * @param blackHole A black hole for avoiding JIT erasure.
     */
